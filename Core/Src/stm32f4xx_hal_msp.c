...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, ADC_CH_5_Pin|ADC_CH_4_Pin|ADC_CH_3_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_CH_1_Pin|ADC_CH_2_Pin);

    HAL_GPIO_DeInit(ADC_CH_0_GPIO_Port, ADC_CH_0_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_IN8
    */
    HAL_GPIO_DeInit(GPIOC, ADC2_QA5_Pin|ADC2_QA2_Pin|ADC2_QA1_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC2_QA6_Pin|ADC2_QA7_Pin|ADC2_QA8_Pin|ADC2_QA4_Pin);

    HAL_GPIO_DeInit(ADC2_QA3_GPIO_Port, ADC2_QA3_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOC, RC1_Pin|RC2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, LC1_Pin|LC2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(TX3_XGP_GPIO_Port, TX3_XGP_Pin);

    HAL_GPIO_DeInit(RX3_XSHUT_GPIO_Port, RX3_XSHUT_Pin);
